...
function requireNative() {
  if (process.env.NAPI_RS_NATIVE_LIBRARY_PATH) {
    ...
    if (process.arch === "arm64") {
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@napi-rs/package-template-pnpm-android-arm64/package.json").version;
        if (
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@napi-rs/package-template-pnpm-android-arm-eabi/package.json").version;
        if (
          bindingPackageVersion !== "1.1.1" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
    ...
    if (process.arch === "x64") {
      if (
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@napi-rs/package-template-pnpm-win32-x64-gnu/package.json").version;
          if (
            bindingPackageVersion !== "1.1.1" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@napi-rs/package-template-pnpm-win32-x64-msvc/package.json").version;
          if (
            bindingPackageVersion !== "1.1.1" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@napi-rs/package-template-pnpm-win32-ia32-msvc/package.json").version;
        if (
          bindingPackageVersion !== "1.1.1" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@napi-rs/package-template-pnpm-win32-arm64-msvc/package.json").version;
        if (
          bindingPackageVersion !== "1.1.1" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
    ...
    try {
      ...
      const bindingPackageVersion =
        require("@napi-rs/package-template-pnpm-darwin-universal/package.json").version;
      if (
        bindingPackageVersion !== "1.1.1" &&
        process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
        process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
    ...
    if (process.arch === "x64") {
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@napi-rs/package-template-pnpm-darwin-x64/package.json").version;
        if (
          bindingPackageVersion !== "1.1.1" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@napi-rs/package-template-pnpm-darwin-arm64/package.json").version;
        if (
          bindingPackageVersion !== "1.1.1" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
    ...
    if (process.arch === "x64") {
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@napi-rs/package-template-pnpm-freebsd-x64/package.json").version;
        if (
          bindingPackageVersion !== "1.1.1" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@napi-rs/package-template-pnpm-freebsd-arm64/package.json").version;
        if (
          bindingPackageVersion !== "1.1.1" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
    ...
    if (process.arch === "x64") {
      if (isMusl()) {
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@napi-rs/package-template-pnpm-linux-x64-musl/package.json").version;
          if (
            bindingPackageVersion !== "1.1.1" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@napi-rs/package-template-pnpm-linux-x64-gnu/package.json").version;
          if (
            bindingPackageVersion !== "1.1.1" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      if (isMusl()) {
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@napi-rs/package-template-pnpm-linux-arm64-musl/package.json").version;
          if (
            bindingPackageVersion !== "1.1.1" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@napi-rs/package-template-pnpm-linux-arm64-gnu/package.json").version;
          if (
            bindingPackageVersion !== "1.1.1" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      if (isMusl()) {
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@napi-rs/package-template-pnpm-linux-arm-musleabihf/package.json").version;
          if (
            bindingPackageVersion !== "1.1.1" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@napi-rs/package-template-pnpm-linux-arm-gnueabihf/package.json").version;
          if (
            bindingPackageVersion !== "1.1.1" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      if (isMusl()) {
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@napi-rs/package-template-pnpm-linux-loong64-musl/package.json").version;
          if (
            bindingPackageVersion !== "1.1.1" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@napi-rs/package-template-pnpm-linux-loong64-gnu/package.json").version;
          if (
            bindingPackageVersion !== "1.1.1" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      if (isMusl()) {
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@napi-rs/package-template-pnpm-linux-riscv64-musl/package.json").version;
          if (
            bindingPackageVersion !== "1.1.1" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@napi-rs/package-template-pnpm-linux-riscv64-gnu/package.json").version;
          if (
            bindingPackageVersion !== "1.1.1" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@napi-rs/package-template-pnpm-linux-ppc64-gnu/package.json").version;
        if (
          bindingPackageVersion !== "1.1.1" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@napi-rs/package-template-pnpm-linux-s390x-gnu/package.json").version;
        if (
          bindingPackageVersion !== "1.1.1" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
    ...
    if (process.arch === "arm64") {
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@napi-rs/package-template-pnpm-openharmony-arm64/package.json").version;
        if (
          bindingPackageVersion !== "1.1.1" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@napi-rs/package-template-pnpm-openharmony-x64/package.json").version;
        if (
          bindingPackageVersion !== "1.1.1" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@napi-rs/package-template-pnpm-openharmony-arm/package.json").version;
        if (
          bindingPackageVersion !== "1.1.1" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
...
if (!nativeBinding || forceWasi) {
  ...
  if (
    ...
    try {
      candidateError = __napiWasiResolveCandidate("./core.wasi.cjs", false, [
        "./core.wasm32-wasi.debug.wasm",
        "./core.wasm32-wasi.wasm",
      ]);
  ...
  if (
    ...
    try {
      candidateError = __napiWasiResolveCandidate(
        "@napi-rs/package-template-pnpm-wasm32-wasi",
        true,
        undefined
      );
      candidateFailed = candidateError !== null;
      if (!candidateFailed) {
        if (
          ...
          const bindingPackageVersion =
            require("@napi-rs/package-template-pnpm-wasm32-wasi/package.json").version;
          if (bindingPackageVersion !== "1.1.1") {
            throw new Error(
              `WASI binding package version mismatch, expected 1.1.1 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`
            );
          }
        }
